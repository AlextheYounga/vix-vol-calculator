...
def build_vix_chain(bounds, k0, ks, put_call_avg):
    """
...
def calculate_strike_contributions(r, t, vix_chain):
    """
    Determining ∆Ki
...
def calculate_vol(f, t, r, selected_chain):
    """
    ...
    for term, options in selected_chain.items():
        ...
        k0, ks = calculateK0(options, f[term])
        bounds = calculate_bounds(k0, ks)
        ...
        vix_chain = build_vix_chain(bounds, k0, ks, put_call_avg)
        contributions = calculate_strike_contributions(r, t[term], vix_chain)
